ActiveAdmin.register Mcq do
  ...
  form title: 'Create New MCQ' do |f|
    f.inputs do
      f.input :subject, label: "Subject Category: ", :as => :select, :collection => ["GK", "Pakistan Current Affairs", "World Current Affairs", "Pakistan Study", "Islamic Studies", "Everyday Science", "English", "Math", "Computer", "Pedagogy", "Physics", "Chemistry", "Biology", "Urdu", "Finance", "HRM", "Marketing", "Accounting", "Auditing", "Electrical Engineering", "Civil Engineering", "Mechanical Engineering", "Chemical Engineering", "Software Engineering", "Medical", "Biochemistry", "Dental Materials", "General Anatomy", "Microbiology", "Oral Anatomy", "Oral Histology", "Oral Pathology and Medicine", "Physiology", "Pharmacology", "Psychology", "Agriculture", "Economics", "Sociology", "Statistics", "English Literature", "Judiciary and Law"]
